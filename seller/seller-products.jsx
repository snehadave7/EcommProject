...
import "./seller-product.css"; // Custom styles for right-side panel
import {
  addProduct,
  deleteProduct,
  EditProduct,
...
import { fetchAllSubCategory } from "../store/subCategorySlice";
...
function SellerProducts() {
  ...
  return (
    <Fragment>
      ...
      {/* Right-side Offcanvas for Add Product */}
      <Offcanvas
        show={openCreateProductDialog}
        onHide={() => setOpenCreateProductDialog(false)}
        placement="end" // Position the Offcanvas to the right
        className="offcanvas-right"
        backdrop="static" // Optional: Disable closing the panel when clicking outside
      >
